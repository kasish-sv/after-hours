...
public class Contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(Contact.this);
        ...
        public void SetValidation() {
            ...
            if (isNameValid && isEmailValid && isMessageValid ) {
                ...
                String res = dbHelper.take_contact(Email,Name,Message,"Donor");
                if (res == "0") {
                    Toast.makeText(Contact.this, "Taken Successfully.", Toast.LENGTH_SHORT).show();
                } else {
