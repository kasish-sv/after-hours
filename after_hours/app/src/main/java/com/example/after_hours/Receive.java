...
public class Receive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(Receive.this);
        ...
        ArrayList<donations> res = dbHelper.get_donations();
        if (res.isEmpty()) {
            Toast.makeText(Receive.this, "No available donations!!", Toast.LENGTH_SHORT).show();
        } else {
            for (donations i : res) {
                d.add(i.toString());
            }
            ...
            donations_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                    ...
                    if (res == "0") {
                        Toast.makeText(Receive.this, "Taken Successfully.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Receive.this, "Please try again later", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
