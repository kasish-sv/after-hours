...
public class Donor_Signup extends AppCompatActivity { ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(Donor_Signup.this);
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener ()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(dbHelper.addNewDonor(email,phone,name,password)==0) {
                    ...
                    Toast.makeText(Donor_Signup.this, "Error in Credentials.", Toast.LENGTH_SHORT) .show();
                }
            }
        });
